...
extension DependencyValues {
    var tunnelProviderManagerFactory: TunnelProviderManagerFactory {
        get { self[TunnelProviderManagerFactory.self] }
        set { self[TunnelProviderManagerFactory.self] = newValue }
    }
}
