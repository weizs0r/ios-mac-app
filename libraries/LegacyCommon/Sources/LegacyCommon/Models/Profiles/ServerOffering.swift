...
public struct ServerWrapper: Codable {
    ...
    public var server: ServerModel {
        if let latestServerModel = ServerManagerImplementation.instance(forTier: CoreAppConstants.VpnTiers.internal, serverStorage: ServerStorageConcrete()).servers.first(where: { (serverModel) -> Bool in
